...
| Execution                                                         | Supported   | Execute, stream, list, get, attach with `Last-Event-ID`, cancel, result and tool calls. Durable human input and artifact list/download are supported; see [human input](human-input.md).                                                                                                                                                 |
...
| Conformance and diagnostics                                       | Suite in CI | The spec's conformance suite runs in CI through `conformance/adapter`: 35 passed, 0 failed. See [conformance.md](conformance.md). The `/conformance` and `/diagnostics` routes answer 501.                                                                                                                                               |
