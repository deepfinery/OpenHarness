 ...
 */
export const vectorStoreKinds = ['weaviate', 'qdrant'] as const;
...
export interface VectorStore {
  ...
  /** Hybrid stores also rank by keyword match; vector-only stores ignore `text`. */
  readonly capabilities: { hybrid: boolean };
